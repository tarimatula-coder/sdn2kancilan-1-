...
$result = mysqli_query($connect, "SELECT * FROM galleries") or die(mysqli_error($connect));
?>
                    ...
                    <div class="col-12">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0 fw-bold">Tabel Galeri</h5>
                                        ...
                                        <tbody>
                                            ...
                                            while ($item = mysqli_fetch_object($result)): ?>
                                                <tr>
                                                    ...
                                                    <!-- 🔥 GAMBAR SUDAH RAPI -->
                                                    <td>
                                                        <img src="../../../storages/galleri/<?= $item->image ?>" class="table-img">
                                                    </td>
