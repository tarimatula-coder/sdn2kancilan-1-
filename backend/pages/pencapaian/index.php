...
$result = mysqli_query($connect, "SELECT * FROM pencapaian") or die(mysqli_error($connect));
?>
                                        ...
                                        <tbody>
                                            ...
                                            while ($item = mysqli_fetch_object($result)): ?>
                                                <tr>
                                                    ...
                                                    <!-- 🔥 GAMBAR SUDAH SAMA -->
                                                    <td>
                                                        <img src="../../../storages/pencapaian/<?= $item->image ?>" class="table-img">
                                                    </td>

                                                    <td><?= nl2br(htmlspecialchars($item->nama)) ?></td>
...
<style>
    /* 🔥 GLOBAL IMAGE (SEMUA HALAMAN SAMA) */
    .table-img {
        width: 100px;
        height: 100px;
        object-fit: cover;
