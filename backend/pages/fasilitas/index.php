...
$result = mysqli_query($connect, "SELECT * FROM fasilitas") or die(mysqli_error($connect));
?>
                    ...
                    <div class="col-12">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0 fw-bold">Tabel Fasilitas</h5>
                                        ...
                                        <tbody>
                                            ...
                                            while ($item = mysqli_fetch_object($result)): ?>
                                                <tr>
                                                    ...
                                                    <!-- 🔥 GAMBAR SUDAH RAPI -->
                                                    <td>
                                                        <img src="../../../storages/fasilitas/<?= $item->image ?>" class="table-img">
                                                    </td>
                                                    ...
                                                    <?php if (in_array($role, ['admin', 'editor'])): ?>
                                                        <td>
                                                            <div class="d-flex justify-content-center gap-2">
                                                                ...
                                                                <?php if ($role == 'admin'): ?>
                                                                    <a href="../../actions/fasilitas/destroy.php?id=<?= $item->id ?>"
