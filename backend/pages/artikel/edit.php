                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Tabel edit data artikel</h5>
                            </div>
                            <div class="card-body">
                                <?php
                                include '../../actions/artikel/show.php';
                                ?>
                                <form action="../../actions/artikel/update.php?id=<?= $artikel->id ?>" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        <img class="w-25" src="../../../storages/artikel/<?= $artikel->image ?>" alt="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="tanggal" class="form-control" id="tanggalInput" placeholder="Masukkan Tanggal..." value="<?= $artikel->tanggal ?>" required>
                                    </div>
