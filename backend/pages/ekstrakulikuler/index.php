...
$result = mysqli_query($connect, "SELECT * FROM ekstrakulikuler") or die(mysqli_error($connect));
?>
                                        ...
                                        <tbody>
                                            ...
                                            while ($item = mysqli_fetch_object($result)): ?>
                                                <tr>
                                                    ...
                                                    <!-- 🔥 GAMBAR SAMA -->
                                                    <td>
                                                        <img src="../../../storages/ekstrakulikuler/<?= $item->image ?>" class="table-img">
                                                    </td>

                                                    <td><?= htmlspecialchars($item->nama) ?></td>
                                                    <td><?= htmlspecialchars($item->pembina) ?></td>
